...
urlpatterns = [
    ...
    path(
        "api/customers/freshbooks/",
        api.get_freshbooks_clients,
        name="freshbooks_client_list",
    ),
    path(
        "api/customers/freshbooks/import/",
        api.get_freshbooks_import_clients,
        name="freshbooks_import_client_list",
    ),
    path(
        "api/customers/freshbooks/import/create/",
        api.import_freshbooks_clients,
        name="freshbooks_import_client",
    ),
    path(
        "api/products/freshbooks/",
        api.get_freshbooks_products,
        name="freshbooks_product_list",
    ),
    path(
        "api/products/freshbooks/import/",
        api.get_freshbooks_import_products,
        name="freshbooks_import_product_list",
    ),
    path(
        "api/products/freshbooks/import/create/",
        api.import_freshbooks_products,
        name="freshbooks_import_product",
    ),
    ...
    path(
        ...
        api.invoice_start_download,
        name="invoice_download_trigger",
    ),
    path(
        "api/invoice/download/status/",
    ...
    path(
        ...
        name="customerproduct_update",
    ),
    path(
        "api/customers/<int:pk>/products/",
        api.customerproduct_list,
        name="customerproduct_list",
    ),
    path(
        "api/customerproduct/<int:pk>/",
        api.customerproduct_detail,
        name="customerproduct_detail",
    ),
    path(
        "api/customerproduct/<int:pk>/delete/",
        api.customerproduct_delete,
        name="customerproduct_delete",
    ),
